...
export const SocialIcon = ({ platform, label }: { platform?: string; label?: string }) => {
  if (!platform) return null
  if (platform in socialIcons) return socialIcons[platform]
  return <span className="text-sm">{label || 'Link'}</span>
}

// Social links container component with different layout options
...
export const SocialLinks: React.FC<SocialLinksProps> = ({
  ...
  return (
    <div className={cn('flex space-x-4', layout === 'center' && 'justify-center', className)}>
