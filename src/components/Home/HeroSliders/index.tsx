      ...
      >
        {activeSliders.map((slider) => (
          <SwiperSlide key={slider.id}>
            <div className="relative w-full h-full flex items-center justify-start px-6 md:px-16 lg:px-24">
              {/* Using Next.js Image for background */}
              <Image
                src={(slider.backgroundImage as Media).url!}
                alt={slider.title || 'Slider background'}
                fill
                priority
                sizes="100vw"
